...
export function MessageTab() {
  ...
  const recordEmit = useAlertManagerStore((s) => s.recordEmit);
  const recordClose = useAlertManagerStore((s) => s.recordClose);
  ...
  const affiliations = parseAffiliationInput(affiliation);
